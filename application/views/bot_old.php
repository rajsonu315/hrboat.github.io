        ...
        <div class="form">
            <div class="bot-inbox inbox">
                ...
                <div class="msg-header">
					...
					<button type="button" class="removebtn" id="feedback">What is your age</button>
		  ...
		  $(document).on("click", ".refer_friend_store", function() {
		   ...
		   $("#send-btn").on("click", function(){
			...
			$(document).on("click", ".excelelnt", function() {
                ...
                // start ajax code
                $.ajax({
                    url: '<?php echo base_url()."home/feedback_store2"; ?>',
                    type: 'POST',
                    data: 'text='+$value,
                    success: function(result){
                        $replay = '<div class="bot-inbox inbox"><div class="icon"><i class="fa fa-user"></i></div><div class="msg-header">'+ result +'</div></div>';
                ...
                $.ajax({
					...
					$(document).on("click", ".55", function() {ot1
                $value = '55 years or more';
                $msg = '<div class="user-inbox inbox"><div class="msg-header"><p>'+ $value +'</p></div></div>';
                $(".form").append($msg);
                $("#data").val('');
                $('.removebtn').remove();
